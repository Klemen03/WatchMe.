...
function About() {
  return (
    <div className="max-w-6xl mx-auto p-3 space-y-4 text-xl">
      <h1 className="text-3xl font-medium text-amber-600">About</h1>
      <p>
        Welcome to out movie database website! We are the team of passionate
      ...
      <p>
        ...
        and trailers. Our movie databse is constantly updated with new releases,
        ...
        release date, making it eary to find the perfect movie for any occasion.
      </p>
      <p>
        In addition to out extensive movie database, we also offer a platform
        for movie lovers to connect and share theur thoughts on the latest
